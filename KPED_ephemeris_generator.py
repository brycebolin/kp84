...
pbpaste > project_pluto_test; python KPED_ephemeris_generator.py -if project_pluto_test -ri 08XXXXXX -pi 8 -on ZTF05yY -fi FILTER_SLOAN_R -exp 30.000 -pn bbolin -cm 9 > ZTF05yY_ephemerides_2019_08_26_to_2019_08_29.csv
